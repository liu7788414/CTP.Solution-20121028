...
[assembly: log4net.Config.XmlConfigurator(ConfigFile = "WrapperTestSandBox.exe.config", Watch = true)]
...
namespace WrapperTest
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                var processes = Process.GetProcessesByName("WrapperTestSandBox");
