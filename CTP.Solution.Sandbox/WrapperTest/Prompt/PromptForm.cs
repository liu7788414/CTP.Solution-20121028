            ...
            if (item != null)
            {
                ...
                if (Utils.InstrumentToLastTick.ContainsKey(ins))
                {
                    ...
                    if (item.SubItems[2].Text.Equals("涨") || item.SubItems[2].Text.Equals("兴"))
                    {
                        ...
                        {
                            _trader.ReqOrderInsert(ins, EnumDirectionType.Buy, lastTick.LastPrice - offset * info.PriceTick, 1, EnumOffsetFlagType.Open, EnumTimeConditionType.GFD, EnumVolumeConditionType.AV, "快捷开多仓");
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        {
                            _trader.ReqOrderInsert(ins, EnumDirectionType.Sell, lastTick.LastPrice + offset * info.PriceTick, 1, EnumOffsetFlagType.Open, EnumTimeConditionType.GFD, EnumVolumeConditionType.AV, "快捷开空仓");
                        }
                        else
                        {
