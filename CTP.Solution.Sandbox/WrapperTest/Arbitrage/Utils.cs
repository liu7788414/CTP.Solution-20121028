    ...
    public static class Utils
    {
        ...
        public static void ReadConfig()
        {
            ...
            if (File.Exists(configFile))
            {
                ...
                line = sr.ReadLine();
                价差上限 = Convert.ToDouble(GetLineData(line));

                line = sr.ReadLine();
                价差下限 = Convert.ToDouble(GetLineData(line));

                line = sr.ReadLine();
                平仓线 = Convert.ToDouble(GetLineData(line));
        ...
        public static string A1 = "rb1801";
        public static string A2 = "rb1805";
        ...
        public static double 价差上限 = 52;
        public static double 价差下限 = 30;
        public static double 平仓线 = 40;
    }
